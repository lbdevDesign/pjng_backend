...
export interface ApiConcertConcert extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Accreditation: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPhotoPhoto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Avendre: Schema.Attribute.Boolean;
    Concerts: Schema.Attribute.Relation<'manyToMany', 'api::concert.concert'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Date: Schema.Attribute.Date;
    Description: Schema.Attribute.String;
    Galeries: Schema.Attribute.Relation<'manyToMany', 'api::galerie.galerie'>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    Tags: Schema.Attribute.Enumeration<['Normal', 'Concert']>;
